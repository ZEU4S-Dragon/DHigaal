...
allProduct.map((product)=>{
    const ProductHtml = `<div class="shadow-lg   px-4 py-6 ">
            ...
            <h3 class="font-mlight py-1"><b>Name: <b/>${product.name}</h3>
            <h3 class="font-medium"><b>Author: <b/>${product.Author}</h3>
            <h3 class="font-medium py-1"><b>Author: <b/>$${product.Price}</h3>
